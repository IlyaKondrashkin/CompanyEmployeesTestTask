...
namespace CompanyEmployeesTestTaskTests
{
    public class SalesTests
    {
        ...
        [TestCase("01.01.2001", 101.9015)]
        [TestCase("01.01.2002", 103.234545)]
            ...
            string onCalculationDate, decimal expectedSalary)
        {
            ...
            var manager = new Sales(TestHelper.EMPLOYEE_NAME, new DateTime(2000, 1, 1), 100);
        ...
        public void CalculateSalary_IncorrectDate_ArgumentException()
        {
            ...
            var sales = new Sales(TestHelper.EMPLOYEE_NAME, new DateTime(2000, 1, 1), 100);

            // Act, Assert.
            Assert.Throws<ArgumentException>(() =>
                sales.CalculateSalary(calculationDate),
